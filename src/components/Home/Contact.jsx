...
const Contact = () => {
    ...
    return (
        <div id="contact" className="w-full py-12 md:py-16">
                ...
                >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-10">
                        ...
                        >
                            ...
                            <motion.div className="mb-6" variants={itemVariants}>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 outline-none transition-all duration-300 text-gray-800"
                            ...
                            <motion.div className="mb-8" variants={itemVariants}>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows="5"
                                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 outline-none transition-all duration-300 text-gray-800 resize-none"
                            ...
                            <motion.button
                                ...
                                className={`px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-full hover:from-blue-600 hover:to-blue-700 transition-all text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed ${status.type === 'loading' ? 'opacity-75' : ''
                                    }`}
                                variants={itemVariants}
                        ...
                        >
                            {/* Our Address Card */}
                            <motion.div
                                className="rounded-3xl p-6 md:p-8 border border-gray-200 hover:shadow-lg transition-shadow duration-300"
                                variants={itemVariants}
                                whileHover={{ y: -5 }}
                            ...
                            >
                                ...
                                <div className="text-gray-600">
                                    ...
                                    <a
                                        ...
                                        className="inline-flex items-center gap-2 mt-4 text-sm text-blue-600 hover:text-blue-800 transition-colors font-medium"
                                    >
                            ...
                            >
                                ...
                                <div className="flex flex-wrap gap-4">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="w-12 h-12 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full flex items-center justify-center hover:from-blue-600 hover:to-blue-700 transition-all"
                                    >
